(function() {
	...
	root.define([
		'backbone',
		'communicator',
		'hbs!tmpl/OrthoQualitySelection',
		'underscore',
		"bootstrap-datepicker"
	],

	function( Backbone, Communicator, OrthoQualitySelectionTmpl ) {

		var OrthoQualitySelectionView = Backbone.Marionette.CompositeView.extend({  

			tagName: "div",
			className: "panel panel-default downloadselection not-selectable",
			template: {type: 'handlebars', template: OrthoQualitySelectionTmpl},
			events: {
				'click #btn-draw-bbox'  : 'onBBoxClick',
				"click #btn-clear-bbox" : 'onClearClick',
				"click #btn-quality"    : 'onQualityClick',
		...
		return {'OrthoQualitySelectionView':OrthoQualitySelectionView};
	});
