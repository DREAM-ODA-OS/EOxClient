(function() 
{
    ...
    root.define(
        ...
        [
            'backbone',
            'communicator',
            'hbs!tmpl/IngestionAdminT6',
            'underscore',
            "bootstrap-datepicker"
        ],

        function( Backbone, Communicator, IngestionAdminT6Tmpl )
        {

            var IngestionAdminT6View = Backbone.Marionette.CompositeView.extend(
            {  

                tagName: "div",
                className: "panel panel-default downloadselection not-selectable",
                template: {type: 'handlebars', template: IngestionAdminT6Tmpl},
                events:
                {
            ...
            }); /* end of IngestionAdminT6View = Backbone.Marionette.CompositeView.extend() */

            return {'IngestionAdminT6View':IngestionAdminT6View};
