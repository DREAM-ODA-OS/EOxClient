(function() 
{
    ...
    root.require(
        ...
        [
            ...
            'globals',
            'app',
            'models/IngestionAdminT6Model',
            'views/IngestionAdminT6View'
        ],

        function( Backbone, Communicator, globals, App, m, ds ) 
        {

            var IngestionAdminT6Controller = Backbone.Marionette.Controller.extend(
            {
                model: new m.IngestionAdminT6Model(), // instantiate the model 
                view: null,                           // 
                ...
                initialize: function(options)
                {
                    ...
                    this.listenTo(Communicator.mediator, "dialog:open:ingestionAdminT6", this.onIngestionAdminOpen);
            
                    // instantiate component's view
                    this.view = new ds.IngestionAdminT6View({model:this.model});
                },
    ...
    */
            ...
            }); /* end of IngestionAdminT6Controller = Backbone.Marionette.Controller.extend() */

            return new IngestionAdminT6Controller();
